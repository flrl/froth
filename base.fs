...
: IF IMMEDIATE COMPILE-ONLY [ ' 0BRANCH ] LITERAL , HERE @ 0 , ;
: THEN IMMEDIATE COMPILE-ONLY DUP HERE @ SWAP - /CELLS SWAP ! ;
: ELSE IMMEDIATE COMPILE-ONLY 
    [ ' BRANCH ] LITERAL , HERE @ 0 , SWAP DUP HERE @ SWAP - /CELLS SWAP ! 
;
: <=> 2DUP < IF -1 ELSE > IF 1 ELSE 0 THEN THEN ;
: CHAR 32 WORD 1+ C@ ;
: BEGIN IMMEDIATE COMPILE-ONLY HERE @ ;
: UNTIL IMMEDIATE COMPILE-ONLY [ ' 0BRANCH ] LITERAL , HERE @ - /CELLS , ;
: AGAIN IMMEDIATE COMPILE-ONLY [ ' BRANCH ] LITERAL , HERE @ - /CELLS , ;
: WHILE IMMEDIATE COMPILE-ONLY [ ' 0BRANCH ] LITERAL , HERE @ 0 , ;
